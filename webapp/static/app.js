document.addEventListener('DOMContentLoaded', () => {
    ...
    form.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            // Clear old bars
            const bartBarsContainer = document.getElementById('bart-bars-container');
            const customBarsContainer = document.getElementById('custom-bars-container');
            if (bartBarsContainer) bartBarsContainer.innerHTML = '';
            if (customBarsContainer) customBarsContainer.innerHTML = '';
            ...
            renderScores(data.bart_scores || data.scores, bartBarsContainer);
            renderScores(data.custom_scores, customBarsContainer);
